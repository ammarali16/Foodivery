...
//
    ...
    public extension UIColor {
        ...
        public struct App {
            ...
            public static let appBlue = UIColor(red: 0, green: 122, blue: 255)
            public static let highlight = UIColor.init(red: 0, green: 122, blue: 255, alpha: 0.1)
            
            public static let lightGray = UIColor(red: 242, green: 242, blue: 242)
            
            public static let silver = UIColor.init(hex: 0xD6D6D6)
            
            public static let aluminium = UIColor(red: 169, green: 169, blue: 169)
            
            public static let tungsten = UIColor(red: 66, green: 66, blue: 66)
            
            public static let segmentSelected = UIColor.init(hex: 0x0368D9)
            public static let segmentUnSelected = UIColor.init(hex: 0x046EE5)
