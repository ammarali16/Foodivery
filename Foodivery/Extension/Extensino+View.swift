...
public extension UIView {
    ...
    public func addShadow(ofColor color: UIColor = #colorLiteral(red: 0.501960814, green: 0.501960814, blue: 0.501960814, alpha: 1),
                          radius: CGFloat = 10,
                          offset: CGSize = .zero,
                          opacity: Float = 0.5) {
    ...
    public func setBorder(withWidth width: CGFloat, Color color: UIColor, Radius radius: CGFloat) {
    ...
    func dropShadow(scale: Bool = true, offset: CGSize, opacity: CGFloat = 0.5) {
